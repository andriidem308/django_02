...
urlpatterns = [
    ...
    path('my_profile/avatar/create/', views.AvatarCreateView.as_view(), name='my_profile_avatar_create'),
    path('my_profile/avatar/list', views.AvatarListView.as_view(), name='my_profile_avatar_list'),
